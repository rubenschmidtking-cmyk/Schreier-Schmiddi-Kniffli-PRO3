...
export const lowerCategories = ['onePair','twoPairs','threeOfAKind','fourOfAKind','fullHouse','smallStraight','largeStraight','kniffli','allEven','allOdd','exact15','exact20','chance'] as const
